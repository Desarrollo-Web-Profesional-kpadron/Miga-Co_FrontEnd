...
export const IconTrash = () => (
  <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 7.5l-1.352 13.23A2.25 2.25 0 0115.9 23H8.1a2.25 2.25 0 01-2.248-2.27L4.5 7.5m5.25 4.5v6m4.5-6v6M9 7.5V4.875c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V7.5M3.75 7.5h16.5" />
  </svg>
);
